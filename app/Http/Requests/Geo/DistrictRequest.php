...
class DistrictRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'city_id' => ($isUpdate ? 'sometimes|' : '') . 'required|string|exists:ref_city,id',
            'code' => ($isUpdate ? 'sometimes|' : '') . 'required|string|max:10|unique:ref_district,code' . ($districtId ? ",{$districtId}" : ''),
