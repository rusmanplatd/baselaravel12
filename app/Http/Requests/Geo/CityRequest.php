...
class CityRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'province_id' => ($isUpdate ? 'sometimes|' : '') . 'required|string|exists:ref_province,id',
            'code' => ($isUpdate ? 'sometimes|' : '') . 'required|string|max:10|unique:ref_city,code' . ($cityId ? ",{$cityId}" : ''),
