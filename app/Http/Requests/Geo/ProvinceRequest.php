...
class ProvinceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'country_id' => ($isUpdate ? 'sometimes|' : '') . 'required|string|exists:ref_country,id',
            'code' => ($isUpdate ? 'sometimes|' : '') . 'required|string|max:10|unique:ref_province,code' . ($provinceId ? ",{$provinceId}" : ''),
