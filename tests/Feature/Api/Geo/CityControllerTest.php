...
it('can create city', function () {
    ...
    $this->assertDatabaseHas('ref_city', $cityData);
});
...
it('can update city', function () {
    ...
    $this->assertDatabaseHas('ref_city', [
        'id' => $city->id,
        'name' => 'Updated City Name'
    ]);
});
...
it('can delete city', function () {
    ...
    $this->assertDatabaseMissing('ref_city', ['id' => $city->id]);
});
...
it('cannot delete city with districts', function () {
    ...
    $this->assertDatabaseHas('ref_city', ['id' => $city->id]);
});
