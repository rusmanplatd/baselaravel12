...
it('can create district', function () {
    ...
    $this->assertDatabaseHas('ref_district', $districtData);
});
...
it('can update district', function () {
    ...
    $this->assertDatabaseHas('ref_district', [
        'id' => $district->id,
        'name' => 'Updated District Name'
    ]);
});
...
it('can delete district', function () {
    ...
    $this->assertDatabaseMissing('ref_district', ['id' => $district->id]);
});
...
it('cannot delete district with villages', function () {
    ...
    $this->assertDatabaseHas('ref_district', ['id' => $district->id]);
});
