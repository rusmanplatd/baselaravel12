...
it('can create country', function () {
    ...
    $this->assertDatabaseHas('ref_geo_country', $countryData);
});
...
it('can delete country', function () {
    ...
    $this->assertDatabaseMissing('ref_geo_country', ['id' => $country->id]);
});
...
it('cannot delete country with provinces', function () {
    ...
    $this->assertDatabaseHas('ref_geo_country', ['id' => $country->id]);
});
