...
it('can create province', function () {
    ...
    $this->assertDatabaseHas('ref_province', $provinceData);
});
...
it('can update province', function () {
    ...
    $this->assertDatabaseHas('ref_province', [
        'id' => $province->id,
        'name' => 'Updated Province Name'
    ]);
});
...
it('can delete province', function () {
    ...
    $this->assertDatabaseMissing('ref_province', ['id' => $province->id]);
});
...
it('cannot delete province with cities', function () {
    ...
    $this->assertDatabaseHas('ref_province', ['id' => $province->id]);
});
