...
import { ShieldCheckIcon, CogIcon, ExclamationTriangleIcon, Hash, MessageSquare } from '@heroicons/react/24/outline';
import { cn } from '@/lib/utils';

interface ChatLayoutWithChannelsProps {
  user: User;
  inviteCode?: string;
}

export default function ChatLayoutWithChannels({ user, inviteCode }: ChatLayoutWithChannelsProps) {
  const {
    conversations,
    activeConversation,
    messages,
