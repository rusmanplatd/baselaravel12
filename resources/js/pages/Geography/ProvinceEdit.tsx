...
const breadcrumbItems = (province: Province): BreadcrumbItem[] => [
    ...
    { href: '', title: `Edit ${province.name}` },
];

export default function ProvinceEdit({ province, countries }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('geography.provinces.update', province.id));
    };
        ...
        <AppLayout breadcrumbs={breadcrumbItems(province)}>
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold">Edit Province</h1>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update the details for {province.name}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="flex items-center gap-4">
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Updating...' : 'Update Province'}
                                </Button>
                                <Button
                                    type="button"
                                    variant="outline"
