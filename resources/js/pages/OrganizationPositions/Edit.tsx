...
export default function Edit({ position, organizationUnits }: Props) {
    const [qualifications, setQualifications] = useState<string[]>(
        position.qualifications?.length ? position.qualifications : ['']
    );
    const [responsibilities, setResponsibilities] = useState<string[]>(
        position.responsibilities?.length ? position.responsibilities : ['']
    );
    ...
    const { data, setData, put, processing, errors } = useForm<{
        ...
        position_level: position.organization_position_level?.code || '',
        job_description: position.job_description || '',
        qualifications: position.qualifications || [] as string[],
        responsibilities: position.responsibilities || [] as string[],
    ...
    useEffect(() => {
        setData('qualifications', qualifications.filter(q => q.trim() !== ''));
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('organization-positions.update', position.id));
    };
