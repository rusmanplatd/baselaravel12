                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <div className="mb-6 flex items-center justify-between">
                                <div>
                                    <h2 className="text-2xl font-semibold text-gray-900">{organization.name} - Members</h2>
                                ...
                                <Dialog open={showAddMember} onOpenChange={setShowAddMember}>
                                    ...
                                    <DialogContent>
                                        <DialogHeader>
                                            ...
                                            <DialogDescription>Add a user as a member of this organization.</DialogDescription>
                                        </DialogHeader>
                                        <form onSubmit={handleSubmit} className="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                {errors.membership_type && <p className="mt-1 text-sm text-red-600">{errors.membership_type}</p>}
                                            </div>
                                            ...
                                            {members.data.length === 0 ? (
                                                ...
                                                members.data.map((member) => (
                                                    <TableRow key={member.id}>
                                                        ...
                                                        <TableCell>
                                                            <span className="capitalize">{member.membership_type.replace('_', ' ')}</span>
                                                        </TableCell>
